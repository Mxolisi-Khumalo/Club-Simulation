	...
	public static void setupGUI(int frameX, int frameY, int[] exits) {
		...
		startB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// FIXED
				clubGrid.started.countDown();
				clubGrid.paused.set(false);
			}
		});
		...
		pauseB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// FIXED
				synchronized (clubGrid.paused) {
					if (clubGrid.paused.get()) {
						clubGrid.paused.set(false);
						clubGrid.paused.notifyAll();
						pauseB.setText("Pause");
					} else {
						clubGrid.paused.set(true);
